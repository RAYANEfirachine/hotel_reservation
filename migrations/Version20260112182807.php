 ...
 */
final class Version20260112182807 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE room (id INT AUTO_INCREMENT NOT NULL, room_type_id INT NOT NULL, room_number VARCHAR(50) NOT NULL, status VARCHAR(50) NOT NULL, image VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_729F519BD7DED995 (room_number), INDEX IDX_729F519B296E3073 (room_type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
